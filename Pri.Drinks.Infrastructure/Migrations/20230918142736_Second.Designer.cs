...
namespace Pri.Drinks.Infrastructure.Migrations
{
    ...
    [Migration("20230918142736_Second")]
            ...
            modelBuilder.Entity("Pri.Drinks.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 9, 18, 14, 27, 35, 855, DateTimeKind.Utc).AddTicks(3059),
                            Name = "Beer"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 9, 18, 14, 27, 35, 855, DateTimeKind.Utc).AddTicks(3061),
                            Name = "Spirits"
                        });
                });
            ...
            modelBuilder.Entity("Pri.Drinks.Core.Entities.Drink", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AlcoholPercentage = 8,
                            CategoryId = 1,
                            Created = new DateTime(2023, 9, 18, 14, 27, 35, 855, DateTimeKind.Utc).AddTicks(3064),
                            Name = "Duvel"
                        },
                        new
                        {
                            ...
                            CategoryId = 2,
                            Created = new DateTime(2023, 9, 18, 14, 27, 35, 855, DateTimeKind.Utc).AddTicks(3065),
                            Name = "Tequila"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Pri.Drinks.Core.Entities.Property", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 9, 18, 14, 27, 35, 855, DateTimeKind.Utc).AddTicks(3062),
                            Name = "Sweet"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 9, 18, 14, 27, 35, 855, DateTimeKind.Utc).AddTicks(3063),
                            Name = "bitter"
                        });
                });
